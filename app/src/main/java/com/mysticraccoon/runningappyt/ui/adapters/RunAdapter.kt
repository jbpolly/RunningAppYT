package com.mysticraccoon.runningappyt.ui.adapters
...
class RunAdapter : RecyclerView.Adapter<RunAdapter.RunViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RunViewHolder, position: Int) {
        ...
        val runImage = holder.itemView.findViewById<ImageView>(R.id.ivRunImage)
        ...
        holder.itemView.apply {
            Glide.with(this).load(run.img).into(runImage)
